...
<html>
   ...
   <body>
    ...
    <div class="slider fullscreen slider_adjust">
      ...
      <b><h1 style="color:whitesmoke;font-family:times new roman">About Us</h1></b>
      <p style="font-size:20px;font-family:times new roman;text-align:center">
 ...
 <!--section-->
  <!--   <section class="container section" id="photo's">
    ...
    <b><h1 style="color:black;font-family:times new roman"> QUICK DELIVERY</h1></b>
      <p style="font-size:20px;font-family:times new roman">
      This is giftstore. Welcome to our store. Maximum opportunites are offered on our website. Kindly look at our collection and order maximum products from our site.
      Safe banking and product tracking is also our feature.This is giftstore. Welcome to our store. Maximum 
  </p>
    ...
    <div class="row" style="margin-left: -1px; margin-top: 20px;">
      ...
      <div class="row" style="margin-top: -20px;">
         <footer class="page-footer black white-text">
            ...
            <div class="row center-align">
              <div class="col s12 m12 l12">
                <a href="#" class="link"> Developed By Dharaneedharan</a>
              </div>
            </div>
             <div class="row center-align">
                <div class="col s12 m12 l12">
